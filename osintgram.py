...
about = """\n Welcome to osintgram \n osintgram is your go-to tool for quickly fetching essential \n information from Instagram profiles without the \n need to log in. It provides you with surface-level details, \n ensuring a seamless experience while respecting privacy.0 \n Explore usernames effortlessly and uncover key profile insights \n with ease. Get started with osintgram today! 😊📷"""
print(about)
